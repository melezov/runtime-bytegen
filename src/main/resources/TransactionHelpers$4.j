...
.class super test/helpers/TransactionHelpers$4
...
.method  <init> : (Ltest/helpers/TransactionHelpers;)V
	...
	aload_0
	aload_1
	putfield test/helpers/TransactionHelpers$4 this$0 Ltest/helpers/TransactionHelpers;
	aload_0
	invokespecial java/lang/Object <init> ()V
	return
.end method

.method public compare : (Ltest/Transaction;)Ljava/math/BigDecimal;
	; method code size: 5 bytes
	.limit stack 1
	.limit locals 2
	aload_1
	invokevirtual test/Transaction getOut ()Ljava/math/BigDecimal;
	areturn
.end method
...
.method synthetic bridge public compare : (Ljava/lang/Object;)Ljava/lang/Comparable;
	...
	invokevirtual test/helpers/TransactionHelpers$4 compare (Ltest/Transaction;)Ljava/math/BigDecimal;
	areturn
.end method

.const [_21] = Utf8 Ljava/lang/Object;Lorg/revenj/patterns/Query$Compare<Ltest/Transaction;Ljava/math/BigDecimal;>;