...
.class super test/helpers/TransactionHelpers$3
...
.method  <init> : (Ltest/helpers/TransactionHelpers;)V
	...
	aload_0
	aload_1
	putfield test/helpers/TransactionHelpers$3 this$0 Ltest/helpers/TransactionHelpers;
	aload_0
...
.method public compare : (Ltest/Transaction;)Ljava/math/BigDecimal;
	...
	.limit locals 2
	aload_1
	invokevirtual test/Transaction getIn ()Ljava/math/BigDecimal;
	areturn
.end method
...
.method synthetic bridge public compare : (Ljava/lang/Object;)Ljava/lang/Comparable;
	...
	invokevirtual test/helpers/TransactionHelpers$3 compare (Ltest/Transaction;)Ljava/math/BigDecimal;
	areturn
.end method
